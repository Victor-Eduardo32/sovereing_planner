...
import { FormExpenseProps } from 'src/types/components/expense/props';
import { stringToDate } from 'src/utils/DateFormat';
import { ref } from 'vue';

const props = defineProps<FormExpenseProps>();
...
<template>
  ...
  >
    <q-card style="width: 100%;">
      ...
      <q-card-section>
        <div>
          <p class="text-bold q-mb-sm">Expense Description</p>
          <q-input
